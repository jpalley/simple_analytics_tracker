...
class HubspotBigquerySyncJob < ApplicationJob
  ...
  HUBSPOT_OBJECTS = {
    ...
    leads: { id_field: "id", batch_size: 100, supports_incremental: true },
    ...
    properties: { id_field: "name", batch_size: 100, single_batch: true, property_groups: [ "contacts", "companies", "deals", "tickets", "leads" ], supports_incremental: false },
